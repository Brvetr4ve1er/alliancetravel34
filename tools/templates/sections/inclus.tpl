...
{{#inclus.included}}        <div class="inclus-item inclus-item--yes" style="--tick-i:{{=i}}">
          <svg class="inclus-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
          <span{{.k}}>{{.t}}</span>
        </div>
{{/inclus.included}}        </div>
      </div>
...
{{#inclus.excluded}}        <div class="inclus-item inclus-item--no" style="--tick-i:{{=i}}">
          <svg class="inclus-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
          <span{{.k}}>{{.t}}</span>
        </div>
{{/inclus.excluded}}        </div>
      </div>
