...
<section class="aurora-hero" data-region="{{region}}" aria-label="{{=d.hero.titlePre + ' — ' + d.hero.titlePost}}">
  ...
  <div class="aurora-hero__inner">
    <p class="aurora-hero__eyebrow">
      ...
      <span data-i18n="istHeroEyebrow">{{hero.eyebrow}}</span>
    </p>
    <h1 class="aurora-hero__title" data-i18n-html="istHeroH1">{{hero.h1Pre}}<em>{{hero.h1Em}}</em></h1>
    <p class="aurora-hero__date" data-i18n="istHeroDate">{{hero.date}}</p>
  </div>
  ...
  <div class="aurora-hero__offer">
    <p class="aurora-hero__price">
      ...
      <span class="aurora-hero__unit" data-i18n="istHeroPriceUnit">{{hero.priceUnit}}</span>
    </p>
    <div class="aurora-hero__actions">
      <a href="#calculator" class="btn btn--primary" data-track-event="hero_cta_calculate" data-i18n="istHeroCtaCalc">Calculer mon prix</a>
...
<!-- slim intro strip: lede + fineprint (carries istHeroLede / istHeroFineprint) -->
<section class="hero-intro" id="hero-intro" data-region="{{region}}" aria-label="Présentation du voyage">
  <div class="container hero-intro__inner">
    <p class="hero-intro__lede" data-i18n="istHeroLede">{{hero.lede}}</p>
    <p class="hero-intro__fineprint" data-i18n="istHeroFineprint">{{hero.fineprint}}</p>
  </div>
</section>
