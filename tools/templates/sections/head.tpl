...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600;9..40,700&family=DM+Sans:ital,opsz,wght@1,9..40,400&display=swap" rel="stylesheet" fetchpriority="high"/>
  <!-- Returning Arabic-preferring visitors: fetch the Arabic webfont right
       ...
       trigger this. -->
  <script>try{if(localStorage.getItem('al-lang')==='ar'){var l=document.createElement('link');l.rel='stylesheet';l.href='https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700&display=swap';l.dataset.arabicFont='1';document.head.appendChild(l);}}catch(e){}</script>
