...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600;9..40,700&family=DM+Sans:ital,opsz,wght@1,9..40,400&family=Sora:wght@400;500;600;700&display=swap" rel="stylesheet"/>
...
<!-- iOS ignores site.webmanifest's display:"standalone" entirely; only these
     three tags make "Add to Home Screen" open without Safari's own chrome.
     short_name matches site.webmanifest exactly, so the two never disagree. -->
