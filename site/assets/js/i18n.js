  ...
  const T = {
    ...
    fr: {
      ...
      nav: {
        ...
        // Trip quick-switcher + drawer button (enhance.js injects them; visual audit R5/R6)
      ...
      visa: {
        ...
        faq: {
        // The 15 French q1..q15 entries were removed 2026-08-31: the page renders 21
        // questions and French resolves from the live DOM baseline, so they never
        // displayed — but their numbering had drifted out of step with T.en/T.ar
        // (fr.q7 was an Umrah question, en/ar q7 is the bank-balance one) and one of
        // them still referred Umrah clients to another agency.
    ...
    en: {
      ...
      visa: {
        ...
        countries: {
          ...
          arabie_saoudite:  { name: 'Saudi Arabia',      provider: 'KSA Embassy, Ben Aknoun · or Nusuk (Umrah) · or visa.visitsaudi.com (tourism)',                          notes: "KSA tourist e-visa is not open to ordinary Algerian passports without a valid Schengen, UK or US visa, or GCC residency. Umrah: visa via the Nusuk platform — we organise the trip and assist you with the procedure (see our Umrah page). Hajj: separate regime via ONHO-licensed agencies (outside our scope)." },
    ...
    ar: {
      ...
      visa: {
        hero: {
          ...
          trust_since: 'وكالة في برج بوعريريج منذ 2019'
        },
        services: {
          eyebrow: 'خدماتنا',
        ...
        countries: {
          ...
          arabie_saoudite: { name: 'المملكة العربيّة السعوديّة',   provider: 'سفارة المملكة، بن عكنون · أو Nusuk (عمرة) · أو visa.visitsaudi.com (سياحة)',                notes: "التأشيرة السياحيّة الإلكترونية للسعوديّة ليست مفتوحة للجوازات الجزائريّة العاديّة دون تأشيرة شنغن أو UK أو US سارية، أو إقامة في دول الخليج. العمرة: التأشيرة عبر منصّة Nusuk — نحن ننظّم الرحلة ونساعدكم في الإجراءات (انظروا صفحة العمرة). الحجّ: نظام مستقلّ عبر وكالات معتمدة من ONHO (خارج نطاق خدماتنا)." },
