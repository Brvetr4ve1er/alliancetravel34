 ...
 * section. A globe was shipped here once and pulled (see the "v28:
 * #alliance-globe removed" gravestone in enhance.js) because it was always-on
 * and costly. This one is built so it can never hurt performance:
 *
...
(() => {
  ...
  function init(THREE, stage, canvas) {
    ...
    function stop() {
      ...
      stage.classList.add('is-paused'); // globe.js owns .is-paused on #globe-stage (see enhance.js v28)
    }
