...
export const STRINGS = {
  fr: {
    ...
    "pages.badprice": "Publication annulée : {n} tarif(s) vide(s) ou invalide(s). Un tarif doit être un nombre entier (0 ou plus). Le champ est surligné.",
  ...
  ar: {
    ...
    "pages.badprice": "أُلغي النشر: {n} سعر فارغ أو غير صالح. يجب أن يكون السعر عددًا صحيحًا (0 أو أكثر). الحقل مُظلَّل.",
